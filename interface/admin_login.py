...
from interface.admin_interface import showAdminInterface


def showAdminLoginWindow():
    window = tkinter.Tk()
    ...
    # Creating widgets
    login_label = tkinter.Label(frame, text="Admin Login", bg='#333333', fg="#FF3399", font=("Arial", 30))
